from scripts.dataset.build_calibration_profile import choose_group, split_reels


def test_split_reels_never_leaks_a_reel():
    scans = [
        {"reel": "a", "width": 800, "width_class": "narrow", "format_class": "narrow", "sweep_class": "sweep_10mhz"},
        {"reel": "a", "width": 801, "width_class": "narrow", "format_class": "narrow", "sweep_class": "sweep_10mhz"},
        {"reel": "b", "width": 1200, "width_class": "wide", "format_class": "wide", "sweep_class": "sweep_20mhz"},
        {"reel": "c", "width": 1201, "width_class": "wide", "format_class": "wide", "sweep_class": "sweep_20mhz"},
    ]
